...
//void handle_rc(sqlite3 *db, int rc, int position) {
//  if (rc != SQLITE_OK) {
//    cout << "postion: " << position << " sqlite3 rc: " << rc << ", error: " << sqlite3_errmsg(db) << endl;
//    exit(rc);
//  }
//}

//int open_test(const char* path) {
//
//  return 38;
//}
int open_test(const char* path) {
